...
export default function Header() {
    return (
        <header>
            {/* Top bar */}
            <div className="topbar bg-dark text-white text-13 py-3">
            ...
            <div className="logo-cart bg-lightGray py-4">
                <div className="lg:container lg:mx-auto px-4 lg:px-0 flex justify-between items-center">
                    <Image src={Logo} alt="logo" className="w-[166px] h-auto"/>
                    <Link href={"/cart"} className="flex gap-2 items-center bg-white py-2.5 px-4 text-13">
